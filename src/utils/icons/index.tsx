...
const WishListIcon: React.FC<IconProps> = ({ className }) => {
  return (
    <svg className={className} role="img" aria-hidden="true" viewBox="0 0 512 512">
      <g>
        <g>
...
export { SearchIcon, SignInIcon, WishListIcon, CartIcon, CloseIcon, HamburgerIcon, PlusIcon, MinusIcon };
